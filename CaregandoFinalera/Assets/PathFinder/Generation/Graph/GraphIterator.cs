...
namespace K_PathFinder.GraphGeneration {
    public class MarchingSquaresIterator {
        ...
        private void SetConnectionType() {
            ...
            if (hashMap[mainX][mainZ] == targetHash) {
                switch (mode) {
                    case MarchingSquaresIteratorMode.area:
            ...
            if (hashMap[mainX + 1][mainZ] == targetHash)
                connectionType |= 1;
            if (hashMap[mainX][mainZ + 1] == targetHash)
                connectionType |= 8;
            if (hashMap[mainX+1][mainZ+1] == targetHash)
                connectionType |= 4;
        }
